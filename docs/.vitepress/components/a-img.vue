...
const visible = ref(!props.dir?.includes('privacy') || !!secretKey)
...
const load = (suffer = '', t: 'src' | 'srcMin' = 'src') => {
  ...
  const request = (url: string): Promise<void> => {
    ...
    return fetch(baseUrl() + url, { mode: 'cors' })
      ...
      .then((content) => {
        const base64 = crypto(content, secretKey || '', 'decrypt')
      ...
      <template #action>
        <div style="display: flex; justify-content: space-between;">
          <div class="a-img-lefaction">
            <button type="text" style="padding:4px 5px;" v-if="!src" @click="loadHD" :loading="loading">
          ...
          <div class="a-img-righaction">
            <button type="text" style="padding:4px 5px;" @click="scaleIn">
            ...
            <button type="text" style="padding:4px 5px;" @click="scaleOut">
